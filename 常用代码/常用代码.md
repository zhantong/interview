...
- [12. 经典题目](#12-经典题目)
  ...
  - [12.53. 求集合的所有子集](#1253-求集合的所有子集)
  - [12.54. 求（元素可重复）集合的所有子集](#1254-求元素可重复集合的所有子集)
  - [12.55. 判断数组arr中是否存在arr\[i\] &lt; arr\[j\] &lt; arr\[k\]](#1255-判断数组arr中是否存在arri-lt-arrj-lt-arrk)
  - [12.56. 查找数组中第k大的数](#1256-查找数组中第k大的数)
  - [12.57. 链表删除倒数第n个结点](#1257-链表删除倒数第n个结点)
  - [12.58. 判断数组是否可以拼接为正方形](#1258-判断数组是否可以拼接为正方形)
  - [12.59. 快速`pow()`](#1259-快速pow)
  - [12.60. 判断数组是否可以分为相等的两部分](#1260-判断数组是否可以分为相等的两部分)
  - [12.61. 在矩阵中查找指定值](#1261-在矩阵中查找指定值)
  - [12.62. 将矩阵顺时针旋转90度](#1262-将矩阵顺时针旋转90度)
  - [12.63. 最长递增子序列](#1263-最长递增子序列)
  - [12.64. 求二维矩阵由左上角到右下角的最小和](#1264-求二维矩阵由左上角到右下角的最小和)
  - [12.65. 将由0、1、2组成的数组排序](#1265-将由012组成的数组排序)
  - [12.66. 求第n位仅由指定因数组成的数字](#1266-求第n位仅由指定因数组成的数字)
  - [12.67. 数组中查找极大值](#1267-数组中查找极大值)
  - [12.68. 判断n能否由平方数的和组成](#1268-判断n能否由平方数的和组成)
  - [12.69. 删除二叉搜索树中的结点](#1269-删除二叉搜索树中的结点)
  - [12.70. 检查字符串是否是合法的二叉树前序遍历结果](#1270-检查字符串是否是合法的二叉树前序遍历结果)
  - [12.71. 中缀表达式转后缀表达式](#1271-中缀表达式转后缀表达式)
  - [12.72. 排列的下一种情况](#1272-排列的下一种情况)
  - [12.73. 求旋转有序数组的最小值](#1273-求旋转有序数组的最小值)
  - [12.74. 在旋转有序数组中查找指定值](#1274-在旋转有序数组中查找指定值)
  - [12.75. 在旋转（元素可重复）有序数组中查找指定值](#1275-在旋转元素可重复有序数组中查找指定值)
  - [12.76. 有序数组中查找特定元素的第一个和最后一个索引](#1276-有序数组中查找特定元素的第一个和最后一个索引)
  - [12.77. 有序数组中查找指定值的插入位置](#1277-有序数组中查找指定值的插入位置)
  - [12.78. 实现`pow(x, n)`](#1278-实现powx-n)
  - [12.79. 第k个排列](#1279-第k个排列)
  - [12.80. 链表向右循环移动k个位置](#1280-链表向右循环移动k个位置)
  - [12.81. 先序遍历和中序遍历构建二叉树](#1281-先序遍历和中序遍历构建二叉树)
  - [12.82. 中序遍历和后序遍历构建二叉树](#1282-中序遍历和后序遍历构建二叉树)
  - [12.83. 求杨辉三角第k行的值](#1283-求杨辉三角第k行的值)
  - [12.84. 克隆图](#1284-克隆图)
  - [12.85. 查找数组中的极大值元素](#1285-查找数组中的极大值元素)
  - [12.86. 将数组合并拼接为最大的数](#1286-将数组合并拼接为最大的数)
  - [12.87. 计算完全二叉树的结点数](#1287-计算完全二叉树的结点数)
  - [12.88. 加减乘除（无括号）计算器](#1288-加减乘除无括号计算器)
  - [12.89. 加减（带括号）计算器](#1289-加减带括号计算器)
  - [12.90. 二叉搜索树中第k小的数](#1290-二叉搜索树中第k小的数)
  - [12.91. 求（元素可更新）数组指定区间的和](#1291-求元素可更新数组指定区间的和)
  - [12.92. 求数组中任意两个元素异或的最大值](#1292-求数组中任意两个元素异或的最大值)
  - [12.93. 二叉搜索树的序列化和反序列化](#1293-二叉搜索树的序列化和反序列化)
  - [12.94. 轮流取数判断先取者是否必胜](#1294-轮流取数判断先取者是否必胜)
  - [12.95. 一串数加上分别加上加号或减号使其结果等于指定值](#1295-一串数加上分别加上加号或减号使其结果等于指定值)
  - [12.96. 有序数组中除一个数仅出现一次外，其他数均出现两次，求这个数](#1296-有序数组中除一个数仅出现一次外其他数均出现两次求这个数)
  - [12.97. 最长任意元素差最大为1的子序列](#1297-最长任意元素差最大为1的子序列)
  - [12.98. 数组中寻找任意三个元素的最大积](#1298-数组中寻找任意三个元素的最大积)
  - [12.99. 生成结点个数为n的所有二叉搜索树](#1299-生成结点个数为n的所有二叉搜索树)
  - [12.100. 数组中除一个数仅出现一次外，其他数均出现三次，求这个数](#12100-数组中除一个数仅出现一次外其他数均出现三次求这个数)
  - [12.101. 将一个数拆分为多个数的和，并使这些数的积最大](#12101-将一个数拆分为多个数的和并使这些数的积最大)
  - [12.102. 轮流取数先取者是否必胜](#12102-轮流取数先取者是否必胜)
  - [12.103. 区间调度问题](#12103-区间调度问题)
    - [12.103.1. 最多区间调度](#121031-最多区间调度)
  - [12.104. 快速替换10亿条标题中的5万个敏感词](#12104-快速替换10亿条标题中的5万个敏感词)
  - [12.105. 轮流取数的必胜策略](#12105-轮流取数的必胜策略)
  - [12.106. 最大公约数（辗转相除法）](#12106-最大公约数辗转相除法)
  - [12.107. 最小公倍数](#12107-最小公倍数)
...
### 12.55. 判断数组arr中是否存在arr[i] &lt; arr[j] &lt; arr[k]
...
### 12.96. 有序数组中除一个数仅出现一次外，其他数均出现两次，求这个数
...
### 12.100. 数组中除一个数仅出现一次外，其他数均出现三次，求这个数
...
[Leetcode 452. Minimum Number of Arrows to Burst Balloons][leetcode_452]
...
[leetcode_452]: https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/description/
