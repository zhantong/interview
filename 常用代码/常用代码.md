...
- [2. 经典题目](#2-经典题目)
  ...
  - [2.126. 快速替换10亿条标题中的5万个敏感词](#2126-快速替换10亿条标题中的5万个敏感词)
  - [2.127. 轮流取数的必胜策略](#2127-轮流取数的必胜策略)
  - [2.128. 最大公约数（辗转相除法）](#2128-最大公约数辗转相除法)
  - [2.129. 最小公倍数](#2129-最小公倍数)
