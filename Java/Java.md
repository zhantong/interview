...
- [14. try-catch-finally-return的执行顺序](#14-try-catch-finally-return的执行顺序)
  - [14.1. try块中没有抛出异常，try、catch和finally块中都有return语句](#141-try块中没有抛出异常trycatch和finally块中都有return语句)
  - [14.2. try块中没有抛出异常，仅try和catch中有return语句](#142-try块中没有抛出异常仅try和catch中有return语句)
  - [14.3. try块中抛出异常，try、catch和finally中都有return语句](#143-try块中抛出异常trycatch和finally中都有return语句)
  - [14.4. try块中抛出异常，try和catch中都有return语句](#144-try块中抛出异常try和catch中都有return语句)
  - [14.5. try、catch中都出现异常，在finally中有返回](#145-trycatch中都出现异常在finally中有返回)
  - [14.6. 只在函数最后出现return语句](#146-只在函数最后出现return语句)
...
### 14.1. try块中没有抛出异常，try、catch和finally块中都有return语句
...
### 14.2. try块中没有抛出异常，仅try和catch中有return语句
...
### 14.3. try块中抛出异常，try、catch和finally中都有return语句
...
### 14.4. try块中抛出异常，try和catch中都有return语句
...
### 14.5. try、catch中都出现异常，在finally中有返回
